        ...
        init: function() {
            (e = document.querySelector("#kt_modal_create_campaign")) && (new bootstrap.Modal(e), t = document.querySelector("#kt_modal_create_campaign_stepper"), a = document.querySelector("#kt_modal_create_campaign_stepper_form"), n = t.querySelector('[data-kt-stepper-action="submit"]'), o = t.querySelector('[data-kt-stepper-action="next"]'), (i = new KTStepper(t)).on("kt.stepper.changed", (function(e) {
                ...
                var o = new Tagify(document.querySelector("#kt_modal_create_campaign_location"), {
                        ...
                        templates: {
                            tag: function(e) {
                                const t = hostUrl + "media/flags/" + e.value.toLowerCase().replace(/\s+/g, "-") + ".svg";
                                try {
                ...
                const c = document.querySelector("#kt_modal_create_campaign_duration_all"),
                    r = document.querySelector("#kt_modal_create_campaign_duration_fixed"),
                    s = document.querySelector("#kt_modal_create_campaign_datepicker");
                [c, r].forEach((e => {
                    e.addEventListener("click", (t => {
                        e.classList.contains("active") || (c.classList.toggle("active"), r.classList.toggle("active"), console.log(r.classList.contains("active")), r.classList.contains("active") ? s.nextElementSibling.classList.remove("d-none") : s.nextElementSibling.classList.add("d-none"))
                    }))
                }));
                ...
                noUiSlider.create(d, {
                    ...
                    console.log(e, t), u.innerHTML = Math.round(e[t]), t && (u.innerHTML = Math.round(e[t]))
